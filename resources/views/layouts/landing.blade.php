...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="images/iconbaru.jpeg" alt="alternative"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="https://github.com/Regian01">Contact</a>
                </li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            ...
                            <p class="p-large">Selamat datang di IoT1, solusi inovatif untuk monitoring dan kontrol lingkungan rumah Anda. Dengan IoT1, Anda bisa mengawasi dan mengendalikan berbagai aspek rumah Anda secara realtime dari mana saja dan kapan saja.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="p-heading p-large">Dengan IoT1, Anda dapat memantau dan mengendalikan berbagai aspek lingkungan rumah Anda hanya dengan sentuhan jari. Dari suhu ruangan hingga tingkat kelembaban, IoT1 memberikan informasi real-time yang Anda butuhkan untuk memastikan kenyamanan dan keamanan rumah Anda.</p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Pantau rumah Anda secara real-time dengan IoT1, solusi pintar untuk monitoring lingkungan yang memastikan keamanan dan kenyamanan setiap saat.</p>
                        </div>
                    </div>
                    <!-- end of card -->
